...
A knight is standing at the top-right corner of the chessboard (field \texttt{h8}).
Two players move it sequentially, but they must move it two fields downwards or leftwards (and then one field in any suitable direction).
For instance, from \texttt{f6} the knight can be moved only to \texttt{g4}, \texttt{e4}, \texttt{d5} or \texttt{d7}.
The player unable to make a move loses.
Which player does have a winning strategy?
What is this strategy?
Can you generalize the answer to an arbitrary size of the field?
...
\medskip
\noindent\textbf{Losing positions on the \(8\times 8\) board.}
...
\medskip
\noindent\textbf{Why these positions are losing.}
...
\medskip
\noindent\textbf{Starting from the corner.}
...
\medskip
\noindent\textbf{Case 1: \(n\equiv1\pmod4\).}
...
\medskip
\noindent\textbf{Case 2: \(n\equiv2\pmod4\).}
...
\medskip
\noindent\textbf{Case 3: \(n\equiv3\pmod4\).}
...
\medskip
\noindent\textbf{Case 4: \(n\equiv0\pmod4\).}
